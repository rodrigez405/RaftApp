...
class KeepAliveHandler:
    ...
    def do_open(self, req):
        ...
        if r.status == 200 or not HANDLE_ERRORS:
            # Modifications for Python2.6 compatability. Also added r.info to return the full response headers when
            # the .info() function is called on the req
            resp = urllib2.addinfourl(r, r.msg, req.get_full_url(), r.info)
            resp.code = r.status
            resp.msg = r.reason
            resp.info = r.info
            return resp
